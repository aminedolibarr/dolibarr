...
class BOM extends CommonObject
{
	...
	public $fields = array(
		...
		'bomtype' => array('type'=>'integer', 'label'=>'Type', 'enabled'=>1, 'visible'=>1, 'position'=>33, 'notnull'=>1, 'default'=>'0', 'arrayofkeyval'=>array(0=>'Manufacturing', 1=>'Disassemble', 2=>'Traitement'), 'css'=>'minwidth175', 'csslist'=>'minwidth175 center'),
    ...
    {
        $sql = "SELECT b.fk_rebutwarehouse";
        $sql .= " FROM ".$this->db->prefix()."bom_bom as b";
        $sql .= " WHERE b.rowid = ".((int) $id);
